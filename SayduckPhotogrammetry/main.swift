...
private let logger = Logger(subsystem: "com.apple.sample.photogrammetry",
                            category: "SayduckPhotogrammetry")
...
struct SayduckPhotogrammetry: ParsableCommand {
            ...
            do {
                for try await output in session.outputs {
                    switch output {
                        ...
                        SayduckPhotogrammetry.handleRequestComplete(request: request, result: result)
                        case .requestProgress(let request, let fractionComplete):
                        SayduckPhotogrammetry.handleRequestProgress(request: request,
